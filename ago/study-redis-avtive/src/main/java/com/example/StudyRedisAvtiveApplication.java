...
@Slf4j
public class StudyRedisAvtiveApplication implements ApplicationRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(StudyRedisAvtiveApplication.class, args);
    }
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        for( Coffee coffeer:list){
            log.info(coffeer.getName());
        }
        ...
        Flux.fromIterable(list)
                ...
                .flatMap(c -> {
                    ...
                    return hashOps.put(KEY, c.getName(), c.getPrice());
                })
